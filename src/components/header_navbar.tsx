...
export default function Header() {
    ...
    return (
					<nav
						ref={navRef}
						className="relative rounded-4xl bg-pill p-1.5 flex gap-2 text-sm backdrop-blur-lg border border-white/10 h-fit shadow-lg shadow-white/5 group max-sm:hidden"
					>
						<motion.div
