...
function Home() {
	return (
		<div className="max-w-340 mx-auto py-20 flex flex-col gap-24 max-md:px-5 max-2xl:px-5 max-sm:gap-5 max-lg:gap-10 max-xl:gap-16 max-2xl:gap-24">
			<div className="absolute -top-6 left-0 w-screen h-screen bg-radial from-amber-600/40 dark:from-cyan-300 dark:brightness-25 blur-3xl via-light to-white/0 dark:via-dark"></div>
			<div className="h-[90vh] flex flex-col justify-center gap-30 z-10 max-sm:h-[50vh] max-2xl:h-[80vh]">
				<div className="flex flex-col">
					<div className="text-8xl font-semibold max-sm:text-5xl max-xl:text-center max-xl:text-6xl">
						...
						<h1 className="h-24">
							product &{" "}
							<span className="font-cycle bg-clip-text text-transparent bg-linear-to-r from-dark to-amber-500 dark:from-light dark:to-slate-400">
								result
							</span>
							.
						</h1>
